...
class ESKF : public FilterInterface {
   public:
    ESKF(const ConfigParameters &params);
    ...
    virtual Eigen::Matrix4d GetPose() const override { return pose_; }
    virtual Eigen::Vector3d GetVelocity() const override { return velocity_; }
   ...
   private:
    ...
    void SetCovarianceP(double posi_noise, double velocity_noise, double ori_noise, double gyro_noise, double accel_noise);
     ...
     * @return
     */
    void ComputeOrientation(const Eigen::Vector3d &angular_delta, const Eigen::Matrix3d &R_nm_nm_1, Eigen::Matrix3d &curr_R, Eigen::Matrix3d &last_R);

    void ComputeVelocity(const Eigen::Matrix3d &R_0, const Eigen::Matrix3d &R_1, const IMUData &imu_data_0, const IMUData &imu_data_1,
     ...
     * @return
     */
    void ComputePosition(const Eigen::Vector3d &last_vel, const Eigen::Vector3d &curr_vel, const IMUData &imu_data_0, const IMUData &imu_data_1);
